        ...
        {trendingAnime.map((anime) => {
          if (anime.cover.length > 0) {
            return (
              ...
              >
                <div className="h-auto sm:h-[22rem] lg:h-[30rem] lg:w-[40%] shadow-neumorphic ring-1 ring-black dark:ring-white ring-opacity-10 dark:ring-opacity-10 px-6 py-4 rounded-[inherit] flex flex-col gap-4 justify-center text-neumorph-secondary">
                  ...
                  <div className="grow flex items-center anime-desc">
                ...
                <div className="h-[15rem] sm:h-[22rem] lg:h-[30rem] w-full grow rounded-[inherit] relative neumorphic-border border-4 border-dotted">
                  <Image
                    src={anime.cover}
