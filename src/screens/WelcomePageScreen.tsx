  ...
  return (
    <>
      <div className="section-welcome">
        <div className="h-full w-full flex flex-col items-center my-5 px-2 gap-5 justify-between">
          ...
          <div className="text-lg max-w-2xl text-center my-4 flex flex-col">
            <span className="">
              <b className="text-neumorph-accent text-opacity-70 text-xl">
                ANS
              </b>{" "}
              will let you{" "}
            ...
            <span className="">
              ...
              everything <b>between your devices</b>.
            </span>
          </div>
          ...
          <Link href={"#app-examples-section"} scroll={false}>
            <HiChevronDoubleDown size={33} />
          </Link>
        </div>
      </div>
        ...
        <div className="favorite-anime-example-row">
          ...
          <div className="flex flex-col justify-center gap-4 h-[325px] max-w-[500px] text-center shadow-neumorphic bg-neumorph-primary rounded-lg p-4">
            <h1 className="text-2xl uppercase inline-flex justify-center items-center gap-2">
              ...
              <GoSync
                size={28}
                className="text-neumorph-accent text-opacity-70"
              />
            </h1>
            <div className="rounded-2xl bg-opacity-20 inline-flex items-center gap-2">
              <p className="">
                ...
                between your{" "}
                <b className="text-neumorph-accent text-opacity-70">devices</b>
              </p>
            </div>
          </div>
        </div>
